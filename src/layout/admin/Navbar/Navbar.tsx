...
function Navbar() {
  ...
  return (
    <>
      <nav className="navbar  bg-[#4D44B5] dark:bg-[#18233a] z-50 hidden md:flex">
        <div className="navbar_box text-[#C1BBEB] dark:text-white ">
          <Image src={LogoImg} />
          <Link className="nav_link" href="/admin">
            <button
              type="button"
              className={
                pathname == "/admin"
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="css-0"> Asosiy</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/teachers">
            <button
              type="button"
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Ustozlar</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/client">
            <button
              type="button"
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                <FaBlackTie size={20} />
                <p className="chakra-text css-0">Mijozlar</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/equipments">
            <button
              type="button"
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Jihozlar</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/product">
            <button
              type="button"
              data-active
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Mahsulotlar</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/order">
            <button
              type="button"
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Buyurtmalar</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/chat">
            <button
              type="button"
              className={
                pathname == "/admin/chat"
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Savol javob</p>
              </div>
            </button>
          </Link>
          <Link className="nav_link" href="/admin/statistics">
            <button
              type="button"
              className={
            ...
            >
              <div className="flex items-center gap-x-2 justify-start">
                ...
                <p className="chakra-text css-0">Statistika</p>
              </div>
            </button>
          </Link>
        </div>
