...
import card from "../../../../public/icons/checkout.svg";
  ...
  return (
    <>
      <header className="    text-black dark:text-white     ">
        <div className="flex  w-full  m-auto  justify-between  items-center">
          <h3 className=" font-extrabold md:text-[24px] text-[16px] text-[#303972] dark:text-white  ">
            {title}
          </h3>
          <div className="chakra-stack flex items-center md:gap-x-2  gap-x-3 ">
            ...
            <Link
              href="/order"
              className=" w-[35px] h-[35px]  md:w-[40px] md:h-[40px] lg:w-[50px] lg:h-[50px] flex items-center justify-center rounded-full bg-white dark:bg-gray-600  "
            >
              <Image
                src={card}
                className=" w-[15px] h-[15px]  md:w-[25px] md:h-[25px] lg:w-[32px] lg:h-[32px]"
              />
            </Link>

            <button className=" w-[35px] h-[35px]  md:w-[40px] md:h-[40px] lg:w-[50px] lg:h-[50px] flex items-center justify-center rounded-full bg-white dark:bg-gray-600  ">
              <Image
                src={Bell}
                className=" w-[15px] h-[15px]  md:w-[25px] md:h-[25px] lg:w-[32px] lg:h-[32px]"
              />
            ...
            <div className="flex items-center ml-3 gap-x-1">
              <p className="md:text-[14px] text-[12px]  text-right text-[#303972] dark:text-white ">
                Komilov M.
                <br />
                <span className="md:text-[14px] text-[12px]  text-[#A098AE] ">
                  Admin
                </span>
              </p>
              <button
