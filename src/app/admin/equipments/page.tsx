...
export default function Page() {
  ...
  async function handleCreate(evt: any) {
    ...
    let response = await instance.post("/post/equipment", data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async function handleDelete(evt: any) {
    ...
    let response = await instance.delete(`/delete/equipment/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async function handleEditSubmit(evt: any) {
    ...
    let response = await instance.put(`/put/equipment/${Id}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
